...
packages <- c("Rcpp", "RcppArmadillo", "RcppEigen", "splines", "mgcv", "Matrix", "MCMCpack", 
              "dplyr", "ggplot2", "profvis",  "tictoc", "scales", "metR", "caret",
...
object_po <- bctm(time ~ hy_sm(time,data=data) + hx_lin(trt),  
...
# model 1 - npo with treatment interaction ----------------------------------------------------------------------------------------------------------------
object_npo <- bctm(time ~ hy_sm(time,data=data) + hyx_vcm(time, by= trt, data=data, center=T, add_to_diag=10e-4),  
...
# $DIC
# DIC       pD     Dbar     Dhat 
# 1009.170  -47.947 1057.118 1105.065 
# 
# $WAIC1
# WAIC1     llpd   pwaic1 
# 1124.014 -553.466    8.541 
# 
# $WAIC2
# WAIC2     llpd   pwaic2 
# 1124.813 -553.466    8.941 
# 
# $LOOIC
# $LOOIC[[1]]
# Estimate        SE
# elpd_loo -562.514263 10.503693
# p_loo       9.048618  1.223495
# looic    1125.028526 21.007386